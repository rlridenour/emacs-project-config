...
#+DATE: Time-stamp: <Last changed 2025-06-08 17:32:57 by rlridenour>
...
#+begin_src emacs-lisp :tangle no
  (use-package terminal-here
    :vc (:url "https://github.com/davidshepherd7/terminal-here"
	      :branch "master")
    :config
...
#+begin_src emacs-lisp :tangle no
  ...
  (define-key (current-global-map) [remap ispell-word] #'jinx-correct)
#+end_src
...
Need to fix. See [[https://github.com/oantolin/math-delimiters][Math Delimiters]]
...
Might need to use an after emacs hook.
