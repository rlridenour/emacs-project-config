...
(define-key dired-mode-map (kbd "j") #'rlr/dired-search-and-enter)
...
(use-package orgonomic
  :vc (:url "https://github.com/aaronjensen/emacs-orgonomic"
	  :branch "master")
  :hook
  (org-mode . orgonomic-mode))
...
(global-set-key (kbd "C-M-S-s-k") #'copy-kill-buffer)
...
(define-key eww-mode-map (kbd "F") #'rlr/open-eww-link-new-buffer)
(define-key eww-mode-map (kbd "T") #'eww-toggle-fonts)
...
(global-set-key (kbd "H-h") #'hydra-hydras/body)
(global-set-key (kbd "s-l") #'hydra-locate/body)
(global-set-key (kbd "s-n") #'hydra-new/body)
(global-set-key (kbd "H-t") #'hydra-toggle/body)
(global-set-key (kbd "H-w") #'hydra-window/body)
(global-set-key (kbd "H-b") #'hydra-buffer/body)
(global-set-key (kbd "C-x 9") #'hydra-logic/body)
...
(global-set-key (kbd "C-c d s") #'insert-date-string)
(global-set-key (kbd "C-c d d") #'insert-standard-date)
(global-set-key (kbd "C-c d b") #'insert-blog-date)
(global-set-key (kbd "C-c d l") #'dictionary-search)
(global-set-key (kbd "C-c D") #'crux-delete-file-and-buffer)

(global-set-key (kbd "C-c f f") #'find-file)
(global-set-key (kbd "C-c f k") #'rlr/kill-other-buffers)
(global-set-key (kbd "C-c f r") #'consult-buffer)
(global-set-key (kbd "C-c f R") #'crux-rename-file-and-buffer)
(global-set-key (kbd "C-c f P") #'open-emacs-config)
(global-set-key (kbd "C-c f S") #'open-fish-functions)

(global-set-key (kbd "C-c g l") #'avy-goto-line)
(global-set-key (kbd "C-c g w") #'avy-goto-word-1)
(global-set-key (kbd "C-c g p") #'pdf-sync-forward-search)

;; "h") #'consult-history)

;; Helpful
(global-set-key (kbd "C-c H c") #'helpful-command)
...
(global-set-key (kbd "C-c k") #'rlr/kill-other-buffers)

(global-set-key (kbd "C-c m") #'consult-mark)

;; Denote search
(global-set-key (kbd "C-c n s") #'denote-search)
(global-set-key (kbd "C-c n d") #'denote-search-marked-dired-files)
(global-set-key (kbd "C-c n r") #'denote-search-files-referenced-in-region)

(global-set-key (kbd "C-c o") #'consult-outline)

;; Projects
(global-set-key (kbd "C-c p f") #'consult-project-buffer)
(global-set-key (kbd "C-c p d") #'project-find-dired)

(global-set-key (kbd "C-c r") #'crux-rename-file-and-buffer)
(global-set-key (kbd "C-c S") #'crux-cleanup-buffer-or-region)
